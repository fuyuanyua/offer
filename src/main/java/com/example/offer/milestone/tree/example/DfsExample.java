 ...
 *
 * 二叉树问题解题思路：
 *      1.【遍历】：是否可以通过遍历一遍二叉树来得到答案？若可以，用一个 traverse 方法配合外部变量来实现
 *      2.【问题分解】：是否可以定义一个递归方法，通过子问题（子树）来推导出答案？如果可以，定义出这个递归方法，并充分历用方法的返回值
 *      3.无论哪一种，都要考虑业务逻辑应该写在前序位置？中序位置？还是后序位置？
 */
